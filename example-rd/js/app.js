    ...
    var nome = document.querySelector("[data-field='nome']");
    var email = document.querySelector("[data-field='email']");
    var empresa = document.querySelector("[data-field='empresa']");
    var telefone = document.querySelector("[data-field='telefone']");
    var cargo = document.querySelector("[data-field='cargo']");
    var segmento = document.querySelector("[data-field='segmento']");
    var funcionarios = document.querySelector("[data-field='funcionarios']");
    var faturamento = document.querySelector("[data-field='faturamento']");
    var optin = document.querySelector("[data-field='opt-in']");
    ...
    var url_pagina = document.querySelector("input[name='url_pagina']");

// -------------------------  Form Validation -------------------------
var form2 = document.querySelector(".form-btn");
...
form2.addEventListener('click', function(e) {
    ...
    var btnSubmit = document.querySelector(".form-btn");
    ...
    if (nome.value.trim() === "") {
        ...
        const sendRD = [
            { name: "identificador", value: "lp-sfa-rd" },
            ...
            { name: "Funcionarios", value: funcionarios.value },
